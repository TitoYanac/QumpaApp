...
class HistorialEnReparto extends StatefulWidget {
  ...
  const HistorialEnReparto(this.usuarioEmpresa, {Key? key}) : super(key: key);
...
class _HistorialEnRepartoState extends State<HistorialEnReparto> {
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HistorialEnRepartoDetalle(
  ...
  Future cargarEnviosEnReparto(CuentaUsuario miUsuario, ancho, context) async {
    String url = "$servidor/Empresa/App_envios_en_proceso.php";

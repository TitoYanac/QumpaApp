...
class ConfiguracionCuentaConductor extends StatefulWidget {
  final CuentaUsuario cuentaUsuario;
  const ConfiguracionCuentaConductor(this.cuentaUsuario, {Key? key})
      : super(key: key);
  @override
  _ConfiguracionCuentaConductorState createState() =>
      _ConfiguracionCuentaConductorState();
}

class _ConfiguracionCuentaConductorState
    extends State<ConfiguracionCuentaConductor> {
  late double ancho;
  late double aux;
  late double alto;
  ...
  actualizarPassword(context) async {
    String url = "$servidor/Conductor/App_Password_Actualizar.php";
...
print('${widget.cuentaUsuario.idCuentaUsuario}, ${passOld.text}, ${passNew.text}' );
...
print("response.body: ${response.body}");
  ...
  suspenderCuenta(context) async {
    String url = "$servidor/Conductor/App_Cuenta_Suspender.php";
    ...
    if (jsonData['0'] == "1") {
      ...
      Error(
          "Ocurrio un Error inesperado!\nNo se ha podido suspender la cuenta.",
          ancho,
          context);
    }
  }
